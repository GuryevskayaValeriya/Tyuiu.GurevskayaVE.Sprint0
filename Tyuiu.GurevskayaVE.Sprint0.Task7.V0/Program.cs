...
using Tyuiu.GurevskayaVE.Sprint0.Task7.V0.Lib;

namespace Tyuiu.GurevskayaVE.Sprint0.Task7.V0
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("Ошибка! Исходные данные имеют разное количество элементов");
            }
            Console.ReadKey();
